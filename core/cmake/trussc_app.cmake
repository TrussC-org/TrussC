...
macro(trussc_app)
    ...
    if(_TC_HOT_RELOAD)
        ...
        elseif(WIN32)
            # On Windows, the Guest DLL links against the Host's import library
            # (generated by ENABLE_EXPORTS). Symbols are resolved at load time.
        else()
        ...
        # On Windows, the Guest links against the Host's import library
        if(WIN32)
